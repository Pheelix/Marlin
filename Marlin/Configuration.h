...
#define CUSTOM_MACHINE_NAME "Ender-3 Max - BF-2.1.x"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -35, -1.75 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define XY_PROBE_FEEDRATE    (199*60) // (mm/min)
