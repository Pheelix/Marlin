...
#define STRING_CONFIG_H_AUTHOR "Pheelix, Ender 3" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Ender-3 - BF-2.1.x"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP  97.2
  #define DEFAULT_BED_KI  19.42
  #define DEFAULT_BED_KD 324.33
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 100, 400, 142 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -35, 10, -3.06 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
 ...
 */
#define EVENT_GCODE_BEFORE_G29 "G1 Z20 F8000\nG1 X5 Y50"
