...
#define STRING_CONFIG_H_AUTHOR "Ender-3 - SKR-mini-E3-V3.0" // Who made the changes.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 12.6307
    #define DEFAULT_Ki 0.6776
    #define DEFAULT_Kd 58.8591
  #endif
#else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 100, 400, 141.5 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -22, -35, -1.05 }
